...
public class HomePageMobileIOSFragment extends HomePageMobileBaseFragment {

    public static HomePageMobileIOSFragment getInstance(Bundle bundle){
        HomePageMobileIOSFragment androidFragment = new HomePageMobileIOSFragment();
    ...
    protected void loadResource(DataCallback<CommonResult<List<CommonResource>>> callback, int pageSize, int pageIndex) {
        ApiService.getInstance().getIOSResource(callback, pageSize, pageIndex);
    }
}
